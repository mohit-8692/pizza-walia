            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  type="url"
                  required
                  className="shadow appearance-none text-black border border-gray-300 rounded w-full py-2 px-3 focus:border-indigo-700 leading-tight focus:outline-none focus:shadow-outline"
                  value={foodData.img}
                />
              </div>
              ...
              <button
                type="submit"
                className="border-gradient font-bold text-white  border-gray-900 rounded p-2 mr-2 hover:bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  hover:text-gray-100"
              >
                Create
              </button>
            </form>
